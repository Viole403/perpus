...
<body>
   ...
   function goToPage() {
    ...
    // --- LOAD DOKUMEN PDF ---
    // Catatan: berbeda dari pdf_viewer.php, endpoint artikel (get_decrypted_content_article)
    // tidak memakai encData()/one-time key, jadi $fileId dipakai langsung apa adanya.
    let pdfUrl = '<?= base_url('katalog/get_decrypted_content_article/' . $fileId) ?>';
