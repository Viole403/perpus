        ...
        <div class="card-header"><i class="header-icon lnr-list icon-gradient bg-plum-plate"> </i>Tabel Survei
            <div class="btn-actions-pane-right actions-icon-btn">
                <?php if (is_allowed('survei/create')) : ?>
                    <a data-toggle="modal" data-target="#modal_create" href="javascript:void(0);" class="btn btn-success" title="Tambah"><i class="fa fa-plus"></i> Survei</a>
                <?php endif; ?>
            </div>
        </div>
        <div class="card-body">
            ...
            <table style="width: 100%;" id="tbl_data" class="table table-hover table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Nama Survei</th>
                        <th class="text-center" width="100">Tgl. Mulai</th>
                        <th class="text-center" width="100">Tgl. Selesai</th>
                        <th class="text-center" width="100">Target Survei</th>
                        <th class="text-center" width="50">Responden</th>
...
<script>
    ...
    $(document).ready(function() {
        t = $('#tbl_data').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": '<?php echo site_url('api/surveipemustaka/datatable/' . $slug) ?>',
            },
