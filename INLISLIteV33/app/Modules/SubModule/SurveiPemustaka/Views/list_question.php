    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Pertanyaan Survei
                    <div class="page-title-subheading">Daftar pertanyaan - <?= $survey->NamaSurvey ?></div>
                </div>
            </div>
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="active breadcrumb-item" aria-current="page">Pertanyaan</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <table style="width: 100%;" id="tbl_data" class="table table-hover table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Pertanyaan Survei</th>
                        <th class="text-center" width="100">Jenis</th>
                        <th class="text-center" width="100">Orientasi</th>
                        <th class="text-center" width="100">Wajib Diisi?</th>
                        <th class="text-center" width="100">Pilihan Ganda?</th>
                        <th class="text-center" width="50">Jumlah Pilihan</th>
                        <th class="text-center" width="50">Urutan</th>
...
<script>
    ...
    $(document).ready(function() {
        t = $('#tbl_data').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": '<?php echo site_url('api/surveipemustaka/question_datatable/' . $survey->ID) ?>',
            },
