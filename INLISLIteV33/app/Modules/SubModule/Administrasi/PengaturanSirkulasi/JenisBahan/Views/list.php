            ...
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Jenis Bahan</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="main-card mb-3 card">
        <div class="card-header">
            ...
            <div class="btn-actions-pane-right">
                  <a data-bs-toggle="modal" data-bs-target="#modal_create" data-toggle="modal" data-target="#modal_create" href="javascript:void(0);"
                        class="btn btn-success" title="Tambah"><i class="fa fa-plus"></i> Tambah Jenis Bahan</a>
