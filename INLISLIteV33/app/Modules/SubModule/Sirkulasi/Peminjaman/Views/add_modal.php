					...
					<div class="form-row">
						<div class="col-lg-6">
							<div class="form-group">
								...
								<div>
									<input required type="text" class="form-control" id="frm_add_MemberNo" name="MemberNo" placeholder="No. Anggota" value="" />
								</div>
							</div>
						</div>
						<div class="col-lg-6">
...
<script>
	$('#frm_add').submit(function(event) {
		...
		var url = "<?= base_url('api/sirkulasi-peminjaman/create') ?>";
