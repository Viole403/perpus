                    ...
                    <div class="col-md-6">
                        ...
                        <div>
                            ...
                            <select class="form-control" name="Jenisanggota_id" id="jenisanggota_id" tabindex="-1" aria-hidden="true">
                                ...
                                <?php foreach (get_ref_table('jenis_anggota', 'id, jenisanggota') as $row) : ?>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <textarea id="frm_create_description" name="Keterangan" placeholder="<?= lang('Perpanjangan.field.description') ?> " rows="2" class="form-control autosize-input" style="min-height: 38px;"><?= set_value('Keterangan') ?></textarea>
                            </div>
                        </div>
                    </div>
