...
class Template extends \Base\Controllers\BaseController
{
    ...
    {
        if (!is_allowed('master-template/access')) {
    ...
    {
        if (!is_allowed('master-template/read')) {
            set_message('toastr_msg', lang('App.permission.not.have'));
            set_message('toastr_type', 'error');
            return redirect()->to('/dashboard');
        }
    ...
    {
        if (!is_allowed('master-template/create')) {
            set_message('toastr_msg', lang('App.permission.not.have'));
            set_message('toastr_type', 'error');
            return redirect()->to('/dashboard');
        }
        ...
        if (
            ...
            $this->data['redirect'] = base_url('master-template/create');
    ...
    {
        if (!is_allowed('master-template/update')) {
            set_message('toastr_msg', lang('App.permission.not.have'));
            set_message('toastr_type', 'error');
            return redirect()->to('/dashboard');
        }
        ...
        $this->data['redirect'] = base_url('master/master-template/edit/' . $id);
        echo view('Template\Views\update', $this->data);
    }

    public function delete(int $id = 0)
    {
        if (!is_allowed('master-template/delete')) {
            set_message('toastr_msg', lang('App.permission.not.have'));
            set_message('toastr_type', 'error');
            return redirect()->to('/dashboard');
        }
